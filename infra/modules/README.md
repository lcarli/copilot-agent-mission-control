...
diagnostic settings, and the API's SignalR App Server assignment. The container
runtime module owns ACR, the shared Container Apps Environment, both workloads,
and registry pull assignments.
