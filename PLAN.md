...
- [x] **TASK-407 — Implement public presentation mode.** Create a redacted, large-screen, multilingual display.
- [x] **TASK-408 — Implement reconnect and state replay.** Recover dashboard state after disconnect or restart.
...
- [x] **TASK-501 — Implement registration and connectivity check.** Join an event and verify required endpoints.
...
- [x] **TASK-610 — Build Mission 1 content and validator.** Deliver Signal in the Storm in all supported languages.
...
- [x] **TASK-615 — Build instructor incident modifiers.** Add safe, documented scenario changes for live facilitation.
- [x] **TASK-616 — Build campaign dry run.** Prove every mission and narrative transition end to end.
...
- [x] **TASK-713 — Run localization parity tests.** Verify keys, placeholders, layout expansion, captions, and asset variants.
